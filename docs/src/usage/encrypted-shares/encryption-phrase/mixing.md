...
```bash
seedmixer mix --lang eng --pin 1234 --threshold 2 --shares 3 --encryption-phrase "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"
```
...
> WARNING: You must store or remember your encryption phrase. If you lose the phraee, you will lose access to your seed as it will no longer be recoverable.
...
```bash
seedmixer mix --lang eng --pin 1234 --threshold 2 --shares 3 --encryption-phrase "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks" --override-file-name lfg
```
